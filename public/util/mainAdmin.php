    ...
    <div class="container mt-4">
        ...
        <div class="row mt-4">
            <div class="col-md-12 text-end">
                <a href="agregarProducto.php" class="btn btn-success btn-lg">
        ...
        <div class="row mt-5">
            <h2 class="text-primary text-center"><i class="bi bi-box-seam"></i> Productos</h2>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><?= htmlspecialchars($producto->muestraResumen()) ?></p>
                        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <h2 class="text-primary text-center"><i class="bi bi-people"></i> Clientes</h2>
