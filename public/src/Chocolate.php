...
class Chocolate extends Dulce
{
    ...
    {
        return "Chocolate: {$this->nombre}, Precio: {$this->precio}€, Categoría: {$this->categoria}, "
            . "Cacao: {$this->porcentajeCacao}%, Peso: {$this->peso}g, Descripción: {$this->descripcion}";
    }
}
?>